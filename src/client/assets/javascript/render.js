...
export function renderRacerCars(racers) {
	if (!racers.length) {
		return `
			<h4>Loading Racers...</4>
		`
...
export function renderRacerCard(racer) {
...
export function renderCountdown(count) {
	return `
...
export function renderRaceStartView(track, racers) {
	return `
		<header>
